...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  // `sizes` must use CSS length units (px, vw). Callers should pass an explicit
  // `size` prop reflecting the image's actual display width per breakpoint.
  // Default assumes full-bleed; safe fallback that avoids overfetching on retina.
