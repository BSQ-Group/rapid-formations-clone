export const faqQuickNavStyles = {
  ...
  item: 'mx-1 block',
  link: 'block py-2 pl-2 pr-5 text-[20px] font-normal leading-[30px] text-[var(--text-on-light-muted)] no-underline hover:text-[var(--text-on-light-link-hover)]',
  linkHome: 'text-[rgb(var(--black))]',
} as const
