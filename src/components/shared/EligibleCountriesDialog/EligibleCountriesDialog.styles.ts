export const styles = {
  content:
    'font-legacy-condensed max-h-[750px] w-full max-w-[720px] gap-0.5 overflow-hidden bg-[var(--surface-canvas)] pt-12 pb-8 pl-8 pr-0 text-[var(--text-on-light-base)] sm:max-w-[720px]',
  overlay: 'bg-black/50',
  ...
  heading:
    'mt-0 mb-2 block text-[28px] font-normal leading-[1.235] text-[var(--text-on-light-base)]',
