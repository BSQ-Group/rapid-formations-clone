export const collapsibleStyles = {
  ...
  trigger:
    'group/collapsible flex w-full cursor-pointer items-center justify-between border-b border-[var(--border-on-light)] bg-transparent pb-2.5 text-left transition-all duration-350 hover:border-b-[var(--surface-brand-cyan)] focus-visible:border-b-[var(--surface-brand-cyan)]',
  ...
  iconCircle:
    'flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-current text-[var(--text-on-light-muted)] transition-all duration-350 group-hover/collapsible:text-[var(--surface-brand-cyan)] group-focus-visible/collapsible:text-[var(--surface-brand-cyan)]',
  iconCircleOpen:
