...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={clsx('dialog__overlay', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={clsx('dialog__title', className)} {...props} />
))
