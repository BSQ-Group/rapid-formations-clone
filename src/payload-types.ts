...
export interface FAQsBlock {
  ...
  title?: string | null;
  /**
   * Sits under the heading. Leave empty to show nothing.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ComparePackagesHeroBlock".
 */
export interface ComparePackagesHeroBlock {
  /**
...
export interface ScholarshipProgrammeBlock {
  ...
  /**
   * Sits between the copy and the winners card, e.g. a mailto: link.
   */
  applyCta: {
    type?: ('reference' | 'custom') | null;
    newTab?: boolean | null;
  ...
  sidebarPartners?: {
    ...
    universities?:
      | {
          /**
           * Used to build the logo alt text, e.g. "University of Leeds logo".
           */
          name: string;
          /**
           * Rendered at its natural size, capped at 160px wide.
           */
          logo: string | Media;
          id?: string | null;
        }[]
...
export interface PageTitleBlock {
  ...
  buyNow?: {
    /**
     * Renders under the price, e.g. "+ £100 Companies House fee".
     */
    priceSuffix?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ComparePackagesHeroBlock_select".
 */
export interface ComparePackagesHeroBlockSelect<T extends boolean = true> {
  title?: T;
  body?: T;
  sectionLayout?:
    | T
 ...
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "eligible-countries".
 */
export interface EligibleCountry {
  id: string;
  /**
   * Shown above the list, e.g. 06 July 2026. Free text, not a date field.
   */
  lastUpdated?: string | null;
  /**
   * Rendered alphabetically in the order held here.
   */
  countries?:
    | {
        name: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "eligible-countries_select".
 */
export interface EligibleCountriesSelect<T extends boolean = true> {
  lastUpdated?: T;
  countries?:
    | T
    | {
