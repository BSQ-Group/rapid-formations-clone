export const promoCardStyles = {
  ...
  card: [
    ...
    // Background image URL comes from the CMS `backgroundImage` field (Figma gradient export).
    'bg-cover bg-center bg-no-repeat bg-[var(--qcf-green-900)]',
  ...
  description: [
    'text-[var(--text-inverse-subtle)]',
    '[&_strong]:font-semibold [&_strong]:text-[var(--text-inverse)]',
    '[&_p]:m-0',
  ].join(' '),

  pricePanel: [
    'flex flex-col items-center',
    'md:items-start md:shrink-0',
  ].join(' '),
