export const businessBankingTableStyles = {
  ...
  scroller:
    'relative my-7 w-full overflow-x-auto focus-visible:ring-4 focus-visible:ring-[var(--border-focus)] focus-visible:outline-none after:pointer-events-none after:absolute after:inset-y-0 after:right-0 after:w-5 after:bg-gradient-to-r after:from-transparent after:to-[rgb(var(--white))]/80 md:after:hidden',
