export const registerOverseasStyles = {
  ...
  sectionHeading:
    'mb-2 block whitespace-pre-line break-words text-center text-[36px] font-normal leading-rf-heading text-[var(--text-on-light-base)]',
  ...
  heading:
    'mb-2 block break-words text-[24px] font-normal leading-rf-heading text-[var(--text-on-light-base)]',
