export const landingHeroStyles = {
  ...
  accreditations:
    'hidden min-[1590px]:flex flex-col items-end gap-4 absolute top-[calc(var(--header-height)+1rem)] right-4 z-10',
  ...
  benefitIconContainer:
    'mt-[7px] size-[18px] shrink-0 rounded-full flex items-center justify-center bg-[var(--icon-success)]',
  ...
  reviewsSection: 'mb-8 md:mb-0 min-[1590px]:mb-8',
  ...
  reviewStarsWrap: 'relative inline-flex h-[34px] w-fit items-start',
  reviewStars: 'flex items-start',
  reviewStar: 'size-[27px] shrink-0',
  reviewBottom:
