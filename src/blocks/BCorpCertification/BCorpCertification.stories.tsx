...
export const TerseCaption: Story = {
  args: {
    ...defaultArgs,
    caption: 'Certified B Corp.',
  },
}
...
export const PortraitMedia: Story = {
  args: {
    ...
    backgroundImage: mediaStub(
      ...
      'Rapid Formations office stairwell',
      1200,
      1800,
    ),
    badge: mediaStub(
      'https://placehold.co/1200x1800/1c1d24/e8f5e9?text=Certified+B+Corp',
      'Rapid Formations is certified B-Corp.',
      1200,
      1800,
    ),
...
export const AbsentMedia: Story = {
  args: {
    ...defaultArgs,
