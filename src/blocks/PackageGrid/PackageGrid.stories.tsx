  ...
  packages: [
    {
      ...
      buyLink: { type: 'custom', url: '/name-check/basic-package/', label: 'Buy Now' },
    ...
    },
    {
      ...
      buyLink: { type: 'custom', url: '/name-check/privacy-package/', label: 'Buy Now' },
    ...
    },
    {
      ...
      buyLink: { type: 'custom', url: '/name-check/all-inclusive-package/', label: 'Buy Now' },
