export const whatsIncludedStyles = {
  section: 'w-full',
  inner:
    'mx-auto max-w-[1024px] px-4 md:px-8 lg:px-10 flex flex-col items-center lg:flex-row lg:items-stretch lg:justify-between gap-14 lg:gap-10',
  ...
  heading:
    'text-[var(--text-strong)] text-[36px] leading-[40px] md:text-4xl md:leading-[40px] lg:text-5xl',

  contentSection: 'flex flex-col gap-3 w-full',
  sectionTitle: 'font-medium text-[var(--text-strong)] lg:text-xl lg:leading-7',
  sectionContent:
    'text-[var(--text-subtle)] [&>p]:text-md [&>p]:leading-6 [&>p:not(:last-child)]:mb-3 [&_a]:text-[var(--text-link)] [&_a]:underline',

  card: 'w-full md:w-[420px] lg:shrink-0 rounded-xl bg-[var(--surface-tertiary)] p-5 md:p-10 flex flex-col gap-4',
  ...
  stackedInner:
    'mx-auto w-full xl:max-w-[792px] px-4 sm:px-8 lg:px-10 xl:px-0 py-20 sm:py-28 flex flex-col gap-10 sm:gap-14',
  ...
  stackedDescription:
    'text-base leading-6 text-[var(--text-subtle)] sm:flex-1 min-w-0 [&>p:not(:last-child)]:mb-3',

  stackedCard: 'w-full rounded-xl bg-[var(--surface-tertiary)] p-5 sm:p-10 flex flex-col gap-4',
